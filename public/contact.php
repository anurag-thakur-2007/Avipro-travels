...
$stmt->execute();
$c = $stmt->fetchColumn();
$contact = $c ? json_decode($contact ?? $c, true) : [];
...
$third_name       = "Diksha Mitra";
$third_phone      = "9991520683";

$fourth_name      = "Deepali Kumari";
$fourth_phone     = "9931877173";
...
<div class="contact-box">
    ...
    <div class="contact-item">
        <i>👤</i>
        <span><strong><?= $third_name ?>:</strong> <?= $third_phone ?></span>
    </div>

    <!-- Deepali -->
    <div class="contact-item">
        <i>👤</i>
        <span><strong><?= $fourth_name ?>:</strong> <?= $fourth_phone ?></span>
    </div>
